...
public class OI {
    ...
    // create a variable visible to all that returns the -1 to +1 value of the throttle
    public double valueThrottle = driveStick.getThrottle();
    ...
    public OI() {
        ...
        buttonStop = new JoystickButton(driveStick, 3);
        buttonStop.whenPressed(new GoStop());
        buttonBackward = new JoystickButton(driveStick, 2);
        buttonBackward.whileHeld(new GoBackward());
        buttonForward = new JoystickButton(driveStick, 1);
