...
public class OI {
    ...
    public JoystickButton cameraChange;
    ...
    public OI() {
        ...
        cameraChange = new JoystickButton(driveStick, 11);
        cameraChange.whenPressed(new SwitchCamera());
        ...
        SmartDashboard.putData("CameraUnit", new CameraUnit());
