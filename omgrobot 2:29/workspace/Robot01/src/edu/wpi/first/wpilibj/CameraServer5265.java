...
public class CameraServer5265 {
  ...
  private static CameraServer5265 server;

  public static CameraServer5265 getInstance() {
    if (server == null) {
      server = new CameraServer5265();
    }
    return server;
  }
  ...
  private CameraServer5265() {
    ...
    serverThread.setName("CameraServer5265 Send Thread");
    serverThread.start();
  }
